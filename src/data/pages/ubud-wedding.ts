// Content for src/app/ubud/wedding/page.tsx.
//
...
// below, and no picture may appear twice on a page.
export const HERO_IMAGES = [
  `${UPLOADS}/2023/02/Ubud-intimate-wedding-1.jpg`,
];

// The live page's brochure download is one PDF linked from two buttons; both
// are kept because both appear on the source page.
export const BROCHURE_HREF = `${UPLOADS}/2024/06/Intimate-Wedding-Package.pdf`;

export const WEDDING_INTRO: PackageItem[] = [
  {
...
export const WEDDING_FIELDS: InquiryField[] = [
