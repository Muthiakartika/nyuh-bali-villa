...
**Read this before "fixing" anything back to match the live site.** The project began as a strict pixel-accurate clone (see the top of this file), but the homepage picker, the About Us pages and the Contact pages were then deliberately redesigned to be "a bit more modern". Those sections are **intentionally different from nyuhbalivillas.com** — do not treat the differences as bugs to correct.
